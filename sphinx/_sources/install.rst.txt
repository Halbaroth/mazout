...
If :code:`mazout` is available in your opam repository, you can just call::
...
Checkout the sources of :code:`mazout` in a directory.

You need a switch with at least version :code:`4.12.0` of OCaml,
