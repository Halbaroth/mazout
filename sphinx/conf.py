...
# -*- coding: utf-8 -*-
#
# mazout documentation build configuration file, created by
# sphinx-quickstart.
#
...
author = 'Pierre Villemot <pierre.villemot@ocamlpro.com>'
...
latex_documents = [
    (master_doc, 'mazout.tex', 'mazout Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'mazout', 'mazout Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mazout', 'mazout Documentation',
     author, 'mazout', 'One line description of project.',
     'Miscellaneous'),
]
